...
- `src/Session_analysis_alex/Tiktok_Session_Analysis_Alex.qmd` — summarizes the Tiktok session dataset visually using multiple plots.
- `src/Session_analysis_alex/Makefile` - runs the script based on the existence of the outputs

## Data
The raw dataset is downloaded to `data/data_session/raw/sessions.csv`
The cleaned dataset is saved in `data/data_session/processed/cleaned_session.csv`
